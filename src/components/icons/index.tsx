...
export const QRIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const WarningIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const LoadingSpinner = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg className={`${className} animate-spin`} width={size} height={size} fill="none" viewBox="0 0 24 24">
